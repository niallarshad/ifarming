 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "farming.com", ownerName = "farming.com", packagePath="app.frontEnd"))
...
public class MessageEndpoint {
   ...
   */
  private static final String API_KEY = "AIzaSyCFiCUjrJ_k4t_c6szICcYCLVvCFgVhqb4";
